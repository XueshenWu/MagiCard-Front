...
<template>
    ...
    <GeneralModal v-model:open='openFreezeModal' width="29.166667vw" :centered="true" mainTitle="谨慎操作">
        <div class="flex flex-col items-center justify-center gap-y-12 p-6">
            <div class="content-style tracking-wider text-center px-4 flex flex-col items-center gap-y-4 justify-start">
                <p>
        ...
        <template #footer>
            <div class="flex flex-row items-center justify-center gap-x-4 mt-8 mb-6 p-2">
                <button @click="openFreezeModal = false"
                    class="content-style px-10 h-[2.708333vw] py-3 w-[100%] bg-slate-200 hover:bg-slate-300 duration-100">取消</button>
                <button @click="openFreezeModal = false"
                    class="content-style px-10 h-[2.708333vw]  py-3 w-[100%] bg-red-500 hover:bg-red-400 duration-100 text-white">确认冻结</button>
        ...
        <template #footer>
            <div class="flex flex-row items-center justify-center gap-x-4 mt-8 mb-6 p-2">
                <button @click="openDeleteModal = false"
                    class="content-style px-10 h-[2.708333vw] py-3 w-[100%] bg-slate-200 hover:bg-slate-300 duration-100">取消</button>
                <button @click="openDeleteModal = false"
                    class="content-style px-10 h-[2.708333vw]  py-3 w-[100%] bg-red-500 hover:bg-red-400 duration-100 text-white">确认删除</button>
