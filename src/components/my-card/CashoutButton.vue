    ...
    :subTitle="t('message.withdrawal.subtitle') ">
        ...
        <template #footer>
            <div class="flex flex-row items-center justify-center gap-x-4 mt-12 px-8 pb-8 ">
                <button :class='`button-style w-[14.0625vw] h-[2.70833vw]  text-[1.04167vw] rounded-lg   ${availableBalance === 0 ? "disabled cursor-not-allowed bg-gray-100 text-gray-400" : " duration-100 bg-blue-500 hover:bg-blue-400 text-white"}`'>{{ t('message.withdrawal.withdrawAll') }}</button>
            </div>
        </template>
